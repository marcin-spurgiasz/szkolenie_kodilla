    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    'form',
                    { className: 'col-md-4 form', onSubmit: function onSubmit(event) {
                            return _this3.onSubmit(event);
                        } },
                    React.createElement('img', { src: './git.png', alt: 'git' }),
                    React.createElement(
                        'label',
                        { htmlFor: 'searchText' },
                        'Search by user name'
                ...
                React.createElement(UsersList, { clssName: 'col-md-4', users: this.state.users })
            );
        }
    }]);
